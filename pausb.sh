...
arch_chroot "mkdir /etc/systemd/system/serial-getty@ttyS0.service.d"
arch_chroot "echo -e '[Service]\nExecStart=\nExecStart=-/usr/bin/agetty --autologin $usr -s %I 115200,38400,9600 vt102' >> /etc/systemd/system/serial-getty@ttyS0.service.d/autologin.conf"
